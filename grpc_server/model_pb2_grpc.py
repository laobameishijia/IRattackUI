...
class ModelServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Detect = channel.unary_unary(
                '/model.ModelService/Detect',
                request_serializer=model__pb2.ModelRequest.SerializeToString,
                response_deserializer=model__pb2.ModelResponse.FromString,
...
def add_ModelServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Detect': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=model__pb2.ModelResponse.SerializeToString,
            ),
    }
...
class ModelService(object):
    ...
    def Detect(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            model__pb2.ModelResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
